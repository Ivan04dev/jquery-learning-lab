...
(!(function (e, t) {
    ...
    Ie = (e) => {
      ...
      if (t && Te) {
        ...
        ((t.style.insetInlineStart = `${Me + (o.isRTL ? -s : s)}px`),
          (t.style.insetBlockStart = `${He + (i - Oe)}px`));
      }
    },
    De = () => {
      const e = C();
  ...
  const nt = () => {
    ...
    it = ot && /iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream,
    st = () => {
      const e = y();
      if (!e) return;
      let t;
    ...
    lt = (e) => e.touches && e.touches.length > 1;
  let ct = null;
  const ut = (e) => {
    null === ct &&
  ...
  const gt = (e) => {
    ...
    bt = (e, t, n) => {
      ...
      ("function" == typeof n.willClose && n.willClose(t),
        ...
        r && s
          ? yt(e, t, s, Boolean(n.returnFocus), n.didClose)
          : s && dt(e, s, Boolean(n.returnFocus), n.didClose));
    },
    yt = (e, t, n, i, s) => {
      o.swalCloseEventFinishedCallback = dt.bind(null, e, n, i, s);
      const r = function (e) {
        var n;
        e.target === t &&
  ...
  const Lt = (e) => {
    ...
    Pt = (e, t) => Boolean(t) && null != t && t.toString() === e.toString(),
    xt = (e, t) => {
      const n = he.innerParams.get(e);
      if (!n.input)
        return void d(
    ...
    St = (e, t) => {
      const n = he.innerParams.get(e);
      if ((n.showLoaderOnDeny && wt(T()), n.preDeny)) {
    ...
    Ht = (e, t) => {
      const n = he.innerParams.get(e);
      if ((n.showLoaderOnConfirm && wt(), n.preConfirm)) {
  ...
  const Wt = {
    ...
    Zt = (e) => Object.prototype.hasOwnProperty.call(Wt, e),
    Jt = (e) => -1 !== Kt.indexOf(e),
    Gt = (e) => Yt[e],
    Qt = (e) => {
    ...
    en = (e) => {
      Xt.includes(e) && u(`The parameter "${e}" is incompatible with toasts`);
    },
    tn = (e) => {
      const t = Gt(e);
      t && m(e, t);
    ...
    nn = (e) => {
      ...
      for (const t in e) (Qt(t), e.toast && en(t), tn(t));
    };
  function on(e) {
    const t = y(),
      n = C(),
  ...
  const dn = (e, t, n) => {
      t.popup.onclick = () => {
        (e && (pn(e) || e.timer || e.input)) || n(ze.close);
      };
    },
    pn = (e) =>
      Boolean(
  ...
  const An = (e) => {
    for (let t = e.target; t && t !== document; t = t.parentNode)
      for (const e in Cn) {
        ...
        if (n) return void Cn[e].fire({ template: n });
      }
  };
  ...
  var En = Object.freeze({
    ...
    argsToParams: (e) => {
      const t = {};
      return (
        "object" != typeof e[0] || bn(e[0])
          ? ["title", "html", "icon"].forEach((n, o) => {
              const i = e[o];
              "string" == typeof i || bn(i)
                ? (t[n] = i)
                : void 0 !== i &&
                  d(
    ...
    bindClickHandler: function (e = "data-swal-template") {
      ((Cn[e] = this),
        wn || (document.body.addEventListener("click", An), (wn = !0)));
    },
    clickCancel: () => {
      var e;
  ...
  const Bn = ["swal-title", "swal-html", "swal-footer"],
    $n = (e) => {
      const t = {};
      return (
    ...
    jn = (e) => {
      ...
      if (
        ...
        D() &&
          (Vn(i, void 0 !== e.scrollbarPadding && e.scrollbarPadding, r),
          (() => {
            const e = y();
  ...
  function Rn(e) {
    (!(function (e) {
      e.inputValidator ||
        ("email" === e.input && (e.inputValidator = Nn),
        "url" === e.input && (e.inputValidator = _n));
    })(e),
  ...
  class zn {
    ...
    _main(e, t = {}) {
      if ((nn(Object.assign({}, t, e)), o.currentInstance)) {
      ...
      const i = Yn(Fn);
      return (Fe(Fn, n), he.innerParams.set(Fn, n), Wn(Fn, i, n));
    }
    then(e) {
  ...
  const Wn = (e, t, n) =>
        ...
        (tt.swalPromiseResolve.set(e, i),
          ...
          (t.confirmButton.onclick = () => {
            ((e) => {
              ...
              (e.disableButtons(), t.input ? xt(e, "confirm") : Ht(e, !0));
            })(e);
          }),
          (t.denyButton.onclick = () => {
            ((e) => {
              const t = he.innerParams.get(e);
              (e.disableButtons(),
                t.returnInputValueOnDeny ? xt(e, "deny") : St(e, !1));
            })(e);
          }),
          ...
          ((e, t, n) => {
            e.toast ? dn(e, t, n) : (hn(t), gn(t), fn(e, t, n));
          })(n, t, r),
          ((e, t, n) => {
            if ((We(e), !t.toast)) {
              const o = (e) => Ze(t, e, n);
    ...
    Kn = (e, t) => {
      const n = ((e) => {
          ...
          return (
            Mn(n),
            Object.assign($n(n), Ln(n), Pn(n), xn(n), Tn(n), Sn(n), On(n, Bn))
          );
        })(e),
  ...
  ((zn.prototype.disableButtons = _t),
    (zn.prototype.enableButtons = Nt),
    (zn.prototype.getInput = Dt),
    (zn.prototype.disableInput = Ft),
    (zn.prototype.enableInput = Rt),
    (zn.prototype.hideLoading = jt),
    (zn.prototype.disableLoading = jt),
    (zn.prototype.showValidationMessage = Ut),
    (zn.prototype.resetValidationMessage = zt),
    (zn.prototype.close = pt),
    (zn.prototype.closePopup = pt),
    (zn.prototype.closeModal = pt),
    (zn.prototype.closeToast = pt),
    (zn.prototype.rejectPromise = ht),
    (zn.prototype.update = on),
